			...
			<div class="footer-col">
				...
				wp_nav_menu([
					...
					'fallback_cb' => function () {
						...
						echo '<li><a href="' . esc_url(home_url('/إعداد-الدعاوى-القضائية/')) . '">' . __('إعداد الدعوي القضائية', 'amal-malki') . '</a></li>';
						echo '<li><a href="' . esc_url(home_url('/المذكرات-الجوابية/')) . '">' . __('المذكرات الجوابية', 'amal-malki') . '</a></li>';
						echo '<li><a href="' . esc_url(home_url('/الاستشارة-القانونية-للشركات/')) . '">' . __('الاستشارة القانونية', 'amal-malki') . '</a></li>';
