...
<section id="hero" class="hero-section" style="background-image: url('<?php echo esc_url( $bg_url ); ?>');" aria-label="<?php esc_attr_e( 'القسم الرئيسي', 'amal-malki' ); ?>">
	...
	<div class="hero-social" aria-label="<?php esc_attr_e( 'روابط التواصل الاجتماعي', 'amal-malki' ); ?>">
		<a href="<?php echo esc_url( $social_instagram ); ?>" class="social-pill" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
			<?php echo amal_get_social_icon( 'instagram' ); ?>
		</a>
		<a href="<?php echo esc_url( $social_tiktok ); ?>" class="social-pill" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
