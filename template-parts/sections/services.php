	...
	<div class="container">
		...
		<?php else : ?>
			...
			<div class="services-grid">
				<?php
				$fallback_services = [
					[ 'title' => __( 'إعداد الدعوى القضائية', 'amal-malki' ),  'excerpt' => __( 'إعداد مذكرات قضائية وصياغة الدعاوى بأعلى معايير المهنة القانونية.', 'amal-malki' ), 'url' => home_url('/إعداد-الدعوي-القضائية/') ],
					...
					[ 'title' => __( 'صياغة وتدقيق العقود', 'amal-malki' ),    'excerpt' => __( 'صياغة العقود ومراجعتها وتدقيقها لحماية حقوقك القانونية.', 'amal-malki' ), 'url' => home_url('/صياغة-العقود/') ],
